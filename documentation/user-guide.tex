...
C or C++, the software includes three C programs that call UltimateKalman
and Windows and Linux scripts that builds executable versions of the
three programs. The scripts compile one of the programs along with
UltimateKalman, link it with BLAS and LAPACK libraries, and run
it. You should be able to use these scripts as examples of how to
compile and link UltimateKalman. In particular, the C implementation
...
just like \texttt{Rotation.java} in Java. The program \texttt{performance.c}
